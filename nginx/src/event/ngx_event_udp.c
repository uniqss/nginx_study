...
static ngx_connection_t *ngx_lookup_udp_connection(ngx_listening_t *ls, struct sockaddr *sockaddr, socklen_t socklen,
    ...
    do {
        ...
        if (c) {
            ...
            if (c->log->log_level & NGX_LOG_DEBUG_EVENT) {
                ...
                ngx_log_debug2(NGX_LOG_DEBUG_EVENT, c->log, 0, "recvmsg: fd:%d n:%z", c->fd, n);
        ...
        *log = ls->log;
...
#if (NGX_DEBUG)
        {
            ...
            if (log->log_level & NGX_LOG_DEBUG_EVENT) {
                ...
                ngx_log_debug4(NGX_LOG_DEBUG_EVENT, log, 0, "*%uA recvmsg: %V fd:%d n:%z", c->number, &addr, c->fd, n);
            }
        }
#endif
